        ...
        return (
			...
			var nametag = twemoji.parse(this.userPublic.name);
                ...
                },
                {
				    ...
				    this.$dialogCont.html(" <video height='270' autoplay controls id='bonziworld-video'><source src='" + a + "' type='video/mp4' loop>Your browser does not support the video tag.</video> "), this.$dialog.show();
                        }
                    },
                },
                {
                    ...
                    value: function (a) {
                        if (!this.mute) {
                            var b = "embed";
                            this.$dialog.addClass('bubble_autowidth');
				    this.$dialogCont.html("<img width='480' src='" + a + "'></img>"), this.$dialog.show();
                        }
                    },
                },
                {
