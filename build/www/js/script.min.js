...
function setup() {
    $("#chat_send").click(sendInput),
        ...
        socket.on("surf_join", function (a) {
            var b = bonzis[a.guid];
            b.cancel(), b.surfjoin();
        }),
        socket.on("surf_leave", function (a) {
            var b = bonzis[a.guid];
    ...
    Bonzi = (function () {
        function a(b, c) {
            ...
            _classCallCheck(this, a),
				...
				if (this.userPublic && this.userPublic.extras && this.userPublic.extras.dvdbounce === 'on') {
				  this._extras.dvd = true;
				};
				this.overlayOffset = {
					left: 0,
					top: 0
				...
				this.moving = {
					speed: 4 * (window.devicePixelRatio || 1),
					direction: 'ne',
				};
            ...
            _createClass(a, [
                ...
                },
                {
					...
					value: function (x, y, force) {
					  ...
					  if (arguments.length !== 0) {
						this.x = x - this.overlayOffset.left;
					  ...
					  this.x = Math.min(Math.max(min.x, this.x), max.x);
					  this.y = Math.min(Math.max(min.y, this.y), max.y);
					  this.$element.css({
						marginLeft: this.x,
						marginTop: this.y
					  }); 
                ...
                },
                {
                    ...
                    value: function () {
                        if (this.run) {
							...
							// Other Tics
							if (this._extras && this._extras.dvd) {
								this.dvdTick();
							}
                    ...
                    value: function (a, b, c) {
                        ...
                        this.$dialogCont[c ? "html" : "text"](a)[e ? "addClass" : "removeClass"]("bubble_greentext").css("display", "block"),
							...
							if (espeaktts == true) {
								...
								if (this.userPublic.color == "rover" || this.userPublic.color == "dogpope") {
									a = new Audio("https://tetyys.com/SAPI4/SAPI4?text=" + encodeURIComponent(b) + "&voice=Sam&pitch=" + this.userPublic.pitch + "&speed=" + this.userPublic.speed);
								} else if (this.userPublic.color == "robby") {
									a = new Audio(
										"https://tetyys.com/SAPI4/SAPI4?text=" + encodeURIComponent(b) + "&voice=Adult%20Male%20%237%2C%20American%20English%20(TruVoice)&pitch=" + this.userPublic.pitch + "&speed=" + this.userPublic.speed
									);
								} else if (this.userPublic.color == "merlin" || this.userPublic.color == "losky") {
									a = new Audio(
										"https://tetyys.com/SAPI4/SAPI4?text=" + encodeURIComponent(b) + "&voice=Adult%20Male%20%233%2C%20American%20English%20(TruVoice)&pitch=" + this.userPublic.pitch + "&speed=" + this.userPublic.speed
									);
								} else if (this.userPublic.color == "genie" || this.userPublic.color == "clippy") {
									a = new Audio(
										"https://tetyys.com/SAPI4/SAPI4?text=" + encodeURIComponent(b) + "&voice=Adult%20Male%20%231%2C%20American%20English%20(TruVoice)&pitch=" + this.userPublic.pitch + "&speed=" + this.userPublic.speed
									);
								} else {
									a = new Audio(
										"https://tetyys.com/SAPI4/SAPI4?text=" + encodeURIComponent(b) + "&voice=Adult%20Male%20%232%2C%20American%20English%20(TruVoice)&pitch=" + this.userPublic.pitch + "&speed=" + this.userPublic.speed
									);
								}
								a.play();
								a.onended = function () {
								...
								// Recycled from https://github.com/mrnotesonic/BonziWORLD-Revived
								var sound = new Howl({ 
									src: ["https://tetyys.com/SAPI4/SAPI4?text=" + encodeURIComponent(b) + "&voice=Adult%20Male%20%232%2C%20American%20English%20(TruVoice)&pitch=" + this.userPublic.pitch + "&speed=" + this.userPublic.speed],
									onend: function () {
										d.clearDialog();
									}	 
								});
								sound.play();
							} else if (espeak_is_cool == true) {
                                    ...
                                    speak.play(
                                        ...
                                        function (a) {
                                            d.goingToSpeak || a.stop(), (d.audioSource = a);
                                        }
                                    );
							}
                    },
                ...
                },
				{
					...
					value: function () {
					  ...
					  // Do North-South
					  if (movement.x <= 0) {
						this.moving.direction = `${this.moving.direction.charAt(0)}e`;
						redo = true;
						redoX = true;
					  } else if (movement.x >= max.x) {
						this.moving.direction = `${this.moving.direction.charAt(0)}w`;
						redo = true;
						redoX = true;
					  }
					  ...
					  // Do East-West
					  if (movement.y <= 101) {
						this.moving.direction = `s${this.moving.direction.slice(1)}`;
						redo = true;
					  } else if (movement.y >= max.y) {
						this.moving.direction = `n${this.moving.direction.slice(1)}`;
						redo = true;
					  }
					  ...
					  if (redo) {
						...
						if (this._extras.dvdTick > this.bounceColors.length - 1) {
						  this._extras.dvdTick = 0;
						}
						...
						if (redoX) {
						  this.sprite.gotoAndPlay(this.moving.direction.charAt(1) === 'w' ? 'surf_across_swap_back' : 'surf_back_swap_back');
						}
					  }
                ...
                },
                {
					...
					value: function youtube(vid) {
						if (!this.mute) {
							var tag = "iframe";
							this.$dialogCont  
								.html('<style>.bubble-content { overflow-x: visible;  overflow-y: visible; } .bubble { width: 505px; height: 290px; }</style><iframe type="text/html" width="480" height="270" src="https://www.youtube.com/embed/' + vid + '?autoplay=1" style="width:480px;height:270px" frameborder="0" allowfullscreen="allowfullscreen" mozallowfullscreen="mozallowfullscreen" msallowfullscreen="msallowfullscreen" oallowfullscreen="oallowfullscreen" webkitallowfullscreen="webkitallowfullscreen"></iframe>')
							this.$dialog.show();
						}
					}
				},
                ...
                },
				{
					...
					value: function updateSpriteForced(hide) {
					...
					value: function updateSprite(anim) {
                      var stage = BonziHandler.oneCanvas ? BonziHandler.stage : this.stage;
					  // this.cancel();
					  stage.removeChild(this.sprite);
					  if (this.colorPrev != this.color) {
						delete this.sprite;
						this.sprite = new createjs.Sprite(BonziHandler.spriteSheets[this.color], anim || 'idle');
						this.sprite.id = this.id;
					  }
                ...
                },
                {
                    key: "swag2",
                    value: function () {
                        var a = [{ type: "anim", anim: "cool_fwd", ticks: 40 },{ type: "anim", anim: "cool_left_fwd", ticks: 40 },{ type: "anim", anim: "cool_left_back", ticks: 30 },{ type: "anim", anim: "cool_right_fwd", ticks: 40 },{ type: "anim", anim: "cool_right_back", ticks: 10 },{ type: "anim", anim: "cool_still", ticks: 5 },{ type: "anim", anim: "cool_adjust", ticks: 30 }];
                        this.runSingleEvent(a);
                    },
                },
                {
    ...
    BonziData = {
        ...
        sprite: {
            ...
            animations: {
                ...
                surf_across_still: 9,
                surf_across_back: { frames: range(8, 1), next: "idle", speed: 1 },      surf_back_swap_fwd: [194, 200, 'surf_back_still', 1],
                ...
                cool_right_back: { frames: range(128, 126), next: "cool_still", speed: 1 },
        ...
        event_list_joke_mid: [
            ...
            [
                { type: "text", text: "What happens if you combine a portugese kid and a dog?" },
                { type: "text", text: "It becomes Doggis!" },
            ],
            [
                { type: "text", text: "What happens if you make BonziWORLD a Playground?" },
                { type: "text", text: "It becomes a fucking abomination so bad that there is actual kids joining in. Without even knowing it's intended for mature audiences" },
            ],
            [
                { type: "text", text: "Who made Battle for Dream Island?" },
                { type: "text", text: "Kirk Johnson." },
            ],
            [
    ...
    window.BonziHandler = new (function () {
        return (
            ...
            (this.prepSprites = function () {
                for (var a = ["black", "blue", "brown", "green", "purple", "pink", "red", "pope"], b = 0; b < a.length; b++) {
                    var c = a[b],
...
if (window.location.hostname == "localhost") {
	...
	var undefined,
		hostname = isApp ? "bonziworld.com" : window.location.hostname,
		socket = io("" + window.location.protocol + "://" + hostname + ":" + window.location.port),
		usersPublic = {},
		bonzis = {},
		debug = !0;
}
$(function () {
    $("#login_go").click(loadTest),
        ...
        socket.on("loginFail", function (a) {
            var b = { nameLength: "Name too long.", full: "Room is full.", nameMal: "Nice try. Why would anyone join a room named that anyway?", banned: "You have been banned from this BonziWORLD!" };
            $("#login_card").show(),
                $("#login_load").hide(),
                $("#login_error")
                    .show()
                    .text("Error: " + b[a.reason] + " (" + a.reason + ")");
			var audio = new Audio("no_login.wav");
			audio.play();
        }),
