                ...
                },
                {
                    ...
                    value: function (a) {
                        if (!this.mute) {
                            ...
                            this.$dialog
				    .addClass("bubble_autowidth")
				    .html(" <video height='270' autoplay controls id='bonziworld-video'><source src='" + a + "' type='video/mp4' loop>Your browser does not support the video tag.</video> "), this.$dialog.show();
                        }
                    },
                },
                {
